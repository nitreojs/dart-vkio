...
class Photos {
  ...
  Future<Map> confirmTag([Map<String, dynamic> params]) async {
  ...
  Future<Map> copy([Map<String, dynamic> params]) async {
  ...
  Future<Map> createAlbum([Map<String, dynamic> params]) async {
  ...
  Future<Map> getAlbumsCount([Map<String, dynamic> params]) async {
  ...
  Future<Map> getAll([Map<String, dynamic> params]) async {
  ...
  Future<Map> getAllComments([Map<String, dynamic> params]) async {
  ...
  Future<Map> getChatUploadServer([Map<String, dynamic> params]) async {
  ...
  ///
  /// `group_id` *(integer)* Community ID.
  Future<Map> getMarketAlbumUploadServer([Map<String, dynamic> params]) async {
  ...
  Future<Map> getMarketUploadServer([Map<String, dynamic> params]) async {
  ...
  Future<Map> getNewTags([Map<String, dynamic> params]) async {
  ...
  Future<Map> getOwnerPhotoUploadServer([Map<String, dynamic> params]) async {
  ...
  ///
  /// `access_key` *(string)*
  Future<Map> getTags([Map<String, dynamic> params]) async {
  ...
  Future<Map> getUserPhotos([Map<String, dynamic> params]) async {
  ...
  ///
  /// `album_id` *(integer)* Album ID.
  Future<Map> makeCover([Map<String, dynamic> params]) async {
  ...
  ///
  /// `photo_id` *(integer)* Photo ID.
  Future<Map> move([Map<String, dynamic> params]) async {
  ...
  Future<Map> putTag([Map<String, dynamic> params]) async {
  ...
  ///
  /// `tag_id` *(integer)* Tag ID.
  Future<Map> removeTag([Map<String, dynamic> params]) async {
  ...
  Future<Map> reorderPhotos([Map<String, dynamic> params]) async {
  ...
  ///
  /// `hash` *(string)* Parameter returned when photos are [uploaded to server](https://vk.com/dev/upload_files).
  Future<Map> saveMarketAlbumPhoto([Map<String, dynamic> params]) async {
  ...
  Future<Map> saveMarketPhoto([Map<String, dynamic> params]) async {
  ...
  ///
  /// `hash` *(string)*
  Future<Map> saveMessagesPhoto([Map<String, dynamic> params]) async {
  ...
  ///
  /// `photo` *(string)* Parameter returned when photos are [uploaded to server](https://vk.com/dev/upload_files).
  Future<Map> saveOwnerCoverPhoto([Map<String, dynamic> params]) async {
  ...
  Future<Map> saveOwnerPhoto([Map<String, dynamic> params]) async {
  ...
  ///
  /// `caption` *(string)* Text describing the photo. 2048 digits max.
  Future<Map> saveWallPhoto([Map<String, dynamic> params]) async {
